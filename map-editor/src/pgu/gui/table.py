...
#             w.rect.w,w.rect.h = w.resize(ww,hh)
        ...
        if width != None: width = max(width,w.rect.w,self.style.width)
        else: width = max(w.rect.w,self.style.width) #,self.style.cell_width)
        if height != None: height = max(height,w.rect.h,self.style.height)
        else: height = max(w.rect.h,self.style.height) #,self.style.cell_height)
